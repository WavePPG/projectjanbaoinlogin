          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td style="color: white;"><?php echo round($average_value1[$date], 2); ?></td>
                <td style="color: white;"><?php echo round($average_value2[$date], 2); ?></td>
                <td style="color: white;"><?php echo round($average_value3[$date], 2); ?></td>
              </tr>
            <?php
              // เพิ่มค่าตัวนับ
              $count++;
